...
export default function PhotoForm({ setPhotos }) {
  ...
  return (
    ...
    <div className='collapse z-10 right-10 w-[20rem] absolute bg-base-200'>
      ...
      <div
        className='collapse-title bg-primary text-primary-content [input:checked~&]:bg-secondary [input:checked~&]:text-secondary-content'>
        Add Photo
      </div>
      ...
      <div
        ...
        <form onSubmit={onSubmit} className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <input required accept='image/jpeg, image/jpg, image/png' onChange={(e) => handleFileChange(e)} name='photo'
